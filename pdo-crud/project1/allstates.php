<?php
  ...
  include("code/allstates.php");
?>
  <div class="content-wrapper">
    <section class="content-header">
      <h1>
        State Data        
        <small><a href="addstate.php">Add New State</a></small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="Admin.php"><i class="fa fa-dashboard"></i> Home</a></li>
        <li><a href="allstates.php">All States</a></li>
      </ol>
    </section>
            ...
            <div class="box-body">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td>
                    <a class="btn btn-primary btn-sm" href="editstate.php?id=<?php echo $row['id']; ?>">
                      <span class="glyphicon glyphicon-pencil"></span>
                    </a>
                  </td>
                  <td>
                    <a 
                      href = "code/deletestate.php?id=<?php echo $row['id']?>" 
